      ...
      <section className="prose">
        ...
        <div className=" mt-10">
            <ul className="list-decimal">
                ...
                <p className="text-[14px] md:text-[14px] text-gray-500 my-5">Welcome to [Your Company/Website Name] ("we," "our," or "us"). This Privacy Policy is designed to help you understand how we collect, use, share, and safeguard your personal information. By using our website or services, you agree to the terms outlined in this policy.</p>
